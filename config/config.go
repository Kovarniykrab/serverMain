...
type Web struct {
	Host         string        `long:"web-host" env:"SERVER_WEB_HOST" envDefault:"localhost"`
	Port         int           `long:"web-port" env:"SERVER_WEB_PORT" envDefault:"8080"`
	...
	LogLevel     zerolog.Level `long:"project-log-level" env:"SERVER_PROJECT_LOG_LEVEL" envDefault:"1"`
}
